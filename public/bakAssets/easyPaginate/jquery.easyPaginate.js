    ...
    return this.each (function (instance) {        
        ...
        var displayNav = function() {
            ...
            if(plugin.settings.firstButton) {
                htmlNav += '<a href="#' + plugin.settings.hashPage +':1" title="Première page" rel="1" class="first">'+plugin.settings.firstButtonText+'</a>';
            }
            
            if(plugin.settings.prevButton) {
                htmlNav += '<a href="" title="Précédent" rel="" class="prev">'+plugin.settings.prevButtonText+'</a>';
            }
