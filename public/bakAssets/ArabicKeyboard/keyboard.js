...
function VKI_buildKeyboardInputs() {
      ...
      for (var y = 0, keyid = "", ex; ex = elem[y++];) {
        if ((ex.nodeName == "TEXTAREA" || ex.type == "text" || ex.type == "password") && ex.className.indexOf("keyboardInput") > -1) {
          ...
          var keybut = document.createElement('img');
            keybut.src = "../../Assets/ArabicKeyboard/keyboard.png";
              keybut.alt = "Keyboard interface";
              keybut.className = "keyboardInputInitiator";
              keybut.title = "Clavier arabe";
 ...
 var logo = document.createElement('span');
   ...
   */
    ...
    this.VKI_position = function () {
        if (self.VKI_visible != "") {
            ...
            console.log("inputElemPos :", inputElemPos);
            ...
            self.VKI_keyboard.style.top = getOffset(self.VKI_target).top - 85 + "px";
            self.VKI_keyboard.style.left = getOffset(self.VKI_target).left + "px";
            console.log("self.VKI_keyboard.style.top :", self.VKI_keyboard.style.top);
            console.log("self.VKI_keyboard.style.left :", self.VKI_keyboard.style.left);
        }
    };
  ...
  //      self.VKI_keyboard.style.right = "0px";
  //  } 
  //};
